...
const HistoryIcon = ({ size = 12, color = '#B2B7BC' }: IconSvg) => {
    return (
        <svg width="19" height="16" viewBox="0 0 19 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M10.8335 0.414062C6.69183 0.414062 3.3335 3.7724 3.3335 7.91406H0.833496L4.07516 11.1557L4.1335 11.2724L7.50016 7.91406H5.00016C5.00016 4.68906 7.6085 2.08073 10.8335 2.08073C14.0585 2.08073 16.6668 4.68906 16.6668 7.91406C16.6668 11.1391 14.0585 13.7474 10.8335 13.7474C9.22516 13.7474 7.76683 13.0891 6.71683 12.0307L5.5335 13.2141C6.89183 14.5724 8.7585 15.4141 10.8335 15.4141C14.9752 15.4141 18.3335 12.0557 18.3335 7.91406C18.3335 3.7724 14.9752 0.414062 10.8335 0.414062ZM10.0002 4.58073V8.7474L13.5418 10.8474L14.1835 9.78073L11.2502 8.03906V4.58073H10.0002Z" fill="#EB2B3E"/>
        </svg>
    )
}
...
const EmailIcon = ({ size = 12, color = '#B2B7BC' }: IconSvg) => {
    return <svg width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M15.6665 0.247314H2.33317C1.4165 0.247314 0.674837 0.997314 0.674837 1.91398L0.666504 11.914C0.666504 12.8306 1.4165 13.5806 2.33317 13.5806H15.6665C16.5832 13.5806 17.3332 12.8306 17.3332 11.914V1.91398C17.3332 0.997314 16.5832 0.247314 15.6665 0.247314ZM15.6665 11.914H2.33317V3.58065L8.99984 7.74731L15.6665 3.58065V11.914ZM8.99984 6.08065L2.33317 1.91398H15.6665L8.99984 6.08065Z" fill="#EB2B3E"/>
    </svg>
}

const DisconnectIcon = ({ size = 12, color = '#B2B7BC' }: IconSvg) => <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
