export const INSURANCE_ABI = [
    { inputs: [], stateMutability: 'nonpayable', type: 'constructor' },
    {
        ...
        inputs: [
            ...
            { indexed: false, internalType: 'uint256', name: 'cover_payout', type: 'uint256' },
            { indexed: false, internalType: 'string', name: 'asset', type: 'string' },
            { indexed: false, internalType: 'uint256', name: 'insurance_value', type: 'uint256' },
            { indexed: false, internalType: 'uint256', name: 'current_price', type: 'uint256' },
            { indexed: false, internalType: 'string', name: 'state', type: 'string' },
            { indexed: false, internalType: 'uint256', name: 'expire', type: 'uint256' },
